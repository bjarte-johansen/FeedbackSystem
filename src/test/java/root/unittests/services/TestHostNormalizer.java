...
public class TestHostNormalizer {
    ...
    public void testNormalize() {
        ...
        assertEquals("power.no", norm("www.power.no"));
        assertEquals("power.no", norm("WWW.POWER.NO"));
        assertEquals("power.no", norm("http://power.no"));
        assertEquals("power.no", norm("https://power.no"));
        assertEquals("power.no", norm("http://www.power.no"));
        assertEquals("power.no", norm("https://www.power.no"));

        assertEquals("sub.google.com", norm("sub.google.com"));
        assertEquals("sub.google.com", norm("http://www.sub.google.com"));
        assertEquals("sub.google.com", norm("https://www.sub.google.com"));
    }
}

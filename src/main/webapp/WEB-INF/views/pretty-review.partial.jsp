        ...
        <div class="box review review--review-${review.id}" data-review-id="${review.id}" data-tenant-id="${tenantId}">
            ...
            <div class="votes mb-0">
                <span class="vote up-votes">
                    <form class="ajax form--like-review" data-handler="likeReviewDone" action="${pageContext.request.contextPath}/api/like-review/${review.id}" method="post" style="display:inline;">
                        <button type="submit">
                ...
                <span class="vote down-votes">
                    <form class="ajax form--like-review" data-handler="dislikeReviewDone" action="${pageContext.request.contextPath}/api/dislike-review/${review.id}" method="post" style="display:inline;">
                        <button type="submit">

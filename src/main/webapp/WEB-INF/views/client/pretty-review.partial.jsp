...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        ...
        <div class="box review review--review-${review.id} mb-2" data-review-id="${review.id}">
            ...
            <div class="votes mb-0">
                <span class="vote up-votes">
                    <form class="ajax form--like-review" data-handler="likeReviewDone" action="${pageContext.request.contextPath}/api/review/${review.id}/like" method="post" style="display:inline;">
                        <button type="submit">
                ...
                <span class="vote down-votes">
                    <form class="ajax form--like-review" data-handler="dislikeReviewDone" action="${pageContext.request.contextPath}/api/review/${review.id}/dislike" method="post" style="display:inline;">
                        <button type="submit">

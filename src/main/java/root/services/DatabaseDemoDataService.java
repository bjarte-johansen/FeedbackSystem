...
@Service
public class DatabaseDemoDataService {
    ...
    public static DatabaseDemoDataService create(){
        return new DatabaseDemoDataService();
    }
    ...
    public void resetPublicSchema(){
        SchemaContext.scopeSchema("public", () -> {
            Logger.withScope("Resetting tenant schema...", () -> {
    ...
    public void resetTenantSchema() {
        Logger.withScope("resetTenantSchema", () -> {
            cleanTenantSchema();

            Logger.withScope(
                "inserting schema demo data '" + SchemaContext.get() + "'",
                this::insertReviews
            );
        });
    }
    ...
    private void insertTenants(){
        Logger.withScope("Inserting tenant", () -> {
            ...
            tenant.setEnableListing(true);
            tenant.setEnableSubmit(true);
